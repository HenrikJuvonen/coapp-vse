...
namespace VsExtension_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void InitializeMenuCommand()
        {
            ...
            CommandID menuCommandID = new CommandID(CoApp.VsExtension.GuidList.guidVsExtensionCmdSet, (int)CoApp.VsExtension.PkgCmdIDList.pkm);
