    ...
    public sealed class VsExtensionPackage : Package
    {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidVsExtensionCmdSet, (int)PkgCmdIDList.console);
                MenuCommand menuToolWin = new MenuCommand(ShowConsoleWindow, toolwndCommandID);
