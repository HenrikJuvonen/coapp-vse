...
namespace CoGet
{
    ...
    public sealed class SemanticVersion : IComparable, IComparable<SemanticVersion>, IEquatable<SemanticVersion>
    {
        ...
        public static SemanticVersion Parse(string version)
        {
            ...
            {
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, CoGetResources.InvalidVersionString, version), "version");
            }
            return semVer;
        }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (other == null)
            {
                throw new ArgumentException(CoGetResources.TypeMustBeASemanticVersion, "obj");
            }
