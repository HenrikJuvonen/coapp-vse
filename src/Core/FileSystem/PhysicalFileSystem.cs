...
namespace CoApp.VisualStudio
{
    public class PhysicalFileSystem : IFileSystem
    {
        ...
        private void WriteAddedFileAndDirectory(string path)
        {
            ...
            {
                Logger.Log(MessageLevel.Debug, FSResources.Debug_AddedFileToFolder, Path.GetFileName(path), folderPath);
            }
            else
            {
                Logger.Log(MessageLevel.Debug, FSResources.Debug_AddedFile, Path.GetFileName(path));
            }
        }
        ...
        public virtual void DeleteFile(string path)
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(folderPath))
                {
                    Logger.Log(MessageLevel.Debug, FSResources.Debug_RemovedFileFromFolder, Path.GetFileName(path), folderPath);
                }
                else
                {
                    Logger.Log(MessageLevel.Debug, FSResources.Debug_RemovedFile, Path.GetFileName(path));
                }
            }
        ...
        public virtual void DeleteDirectory(string path, bool recursive)
        {
            ...
            try
            {
                ...
                Logger.Log(MessageLevel.Debug, FSResources.Debug_RemovedFolder, path);
            }
