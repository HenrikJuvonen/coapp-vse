...
namespace VsExtension_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(CoApp.VsExtension.GuidList.guidVsExtensionCmdSet, (int)CoApp.VsExtension.PkgCmdIDList.pkm);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VsExtension", "CoApp.VsExtension.VsExtensionPackage");
